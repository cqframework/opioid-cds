...
COPY input\vocabulary\valueset\valueset-condition-encounter-diagnosis-category bunlegen\sourcefiles\valueset-condition-encounter-diagnosis-category
COPY input\vocabulary\valueset\valueset-condition-problem-list-category bunlegen\sourcefiles\valueset-condition-problem-list-category
COPY input\vocabulary\valueset\valueset-condition-us-core-health-concern-category bunlegen\sourcefiles\valueset-condition-us-core-health-concern-category
...
COPY input\vocabulary\valueset\valueset-medicationrequest-category-community bunlegen\sourcefiles\valueset-medicationrequest-category-community
COPY input\vocabulary\valueset\valueset-medicationrequest-status-active bunlegen\sourcefiles\valueset-medicationrequest-status-active
...
COPY input\vocabulary\valueset\valueset-observation-category-laboratory bunlegen\sourcefiles\valueset-observation-category-laboratory
COPY input\vocabulary\valueset\valueset-observation-category-procedure bunlegen\sourcefiles\valueset-observation-category-procedure
