...
COPY input\vocabulary\valueset\valueset-cdc-malignant-cancer-conditions-enum.json bundlegen\sourcefiles\valueset-cdc-malignant-cancer-conditions-enum.json
COPY input\vocabulary\valueset\valueset-conditions-likely-terminal-for-opioid-prescribing-enum.json bundlegen\sourcefiles\valueset-conditions-likely-terminal-for-opioid-prescribing-enum.json
...
COPY input\vocabulary\valueset\valueset-limited-life-expectancy-conditions-enum.json bundlegen\sourcefiles\valueset-limited-life-expectancy-conditions-enum.json
...
COPY input\vocabulary\valueset\valueset-oncology-specialty-designations-enum.json bundlegen\sourcefiles\valueset-oncology-specialty-designations-enum.json
...
COPY input\vocabulary\valueset\valueset-opioid-misuse-disorders-enum.json bundlegen\sourcefiles\valueset-opioid-misuse-disorders-enum.json
...
COPY input\vocabulary\valueset\valueset-substance-misuse-behavioral-counseling-enum.json bundlegen\sourcefiles\valueset-substance-misuse-behavioral-counseling-enum.json
COPY input\vocabulary\valueset\valueset-therapies-indicating-end-of-life-care-enum.json bundlegen\sourcefiles\valueset-therapies-indicating-end-of-life-care-enum.json
